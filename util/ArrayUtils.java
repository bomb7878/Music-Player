...
public class ArrayUtils {
    ...
    */
    ...
    public static <T> T readFromConsole(String name, java.ru.vsu.cs.ru.vsu.cs.ru.vsu.cs.util.function.Function<String, T> converter) {
        Scanner scanner = new Scanner(System.in);
        while (true) {
            try {
    ...
    private static <T> T readArrayFromConsole(String arrName, java.ru.vsu.cs.ru.vsu.cs.ru.vsu.cs.util.function.Function<String, T> strToArrConverter) {
